...
<html>
    ...
    <body>
            ...
            <h1 class="display-4 text-center titulo"> Listado de Socios del Gym </h1>
        
            

        <div class="container">
            <div class="row">   
                <a class="btn btn-primary col-2 m-4" href="SociosController?accion=nuevo">Agregar Socio</a>
                 <a class="btn btn-primary col-2 m-4" href="SociosController? ">Inicio</a>
				...
				%>                
                    ...
                    <tr>
                         ...
                         <td class="text-center"><a href=<%= ruta %>> <i class="fa-solid  fas fa-edit"></i> </a></td>
			 <td class="text-center"><a href=<%=rutaE%>><i class="fa-solid fas fa-trash-alt"></i> </a></td>
